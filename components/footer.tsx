...
export default function Footer() {
  ...
  return (
    <footer className="bg-blue-100 dark:bg-blue-800 text-gray-800 dark:text-gray-100 py-4 mt-auto">
      <div className="container-xl lg:container mx-auto flex flex-col md:flex-row items-center justify-between px-4">
          ...
          <ul className="flex space-x-4">
            <li>
              <Link
                ...
                } px-3 py-2 rounded-md text-gray-100 hover:text-gray-800 hover:dark:text-gray-100 hover:bg-gray-700 dark:hover:bg-gray-800`}
                href="/"
              >
                Home
              </Link>
        ...
        <div>
          <p className="text-sm text-gray-800 dark:text-gray-100 mt-2 md:mt-0">
